...
public class CustomAdaptarRemind extends ArrayAdapter<Mirror> {
    ...
    public CustomAdaptarRemind(@NonNull Context context, int resource, @NonNull ArrayList<Mirror> objects, @NonNull ArrayList<String> obj, String user) {
