...
public class CustomAdaptarAlarm extends ArrayAdapter<Mirror> {
    ...
    public CustomAdaptarAlarm(@NonNull Context context, int resource, @NonNull ArrayList<Mirror> objects, @NonNull ArrayList<String> obj,String user) {
