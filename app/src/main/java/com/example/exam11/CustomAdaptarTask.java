...
public class CustomAdaptarTask extends ArrayAdapter<Mirror> {
    ...
    public CustomAdaptarTask(@NonNull Context context, int resource, @NonNull ArrayList<Mirror> objects, @NonNull ArrayList<String> obj, String user) {
